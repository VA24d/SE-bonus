...
\begin{table}[htbp]
\caption{Directly measured CPU package power and energy per benchmark (Apple M2, \texttt{powermetrics --samplers cpu\_power}, 500\,ms interval).}
\label{tab:hw_power}
\centering
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|l|r|r|r|r|}
\hline
\textbf{Benchmark} & \textbf{Dur. (s)} & \textbf{Mean (mW)} & \textbf{Peak (mW)} & \textbf{Energy (J)} \\
\hline

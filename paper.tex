...
\end{equation}
where $E$ is operational energy, $I$ is the grid carbon intensity, $M$ is the embodied carbon of the hardware, and $R$ represents the functional unit (e.g., events processed). Reducing the CPU and network overhead directly lowers the operational energy ($E$) component of the SCI score \cite{b1, b2}.
